...
// ============================================================================
// Nested I2CDevice class implementation
// ============================================================================

LSM9DS0Driver::I2CDevice::I2CDevice(const char* device) {
#if PLATFORM_LINUX
...
LSM9DS0Driver::I2CDevice::~I2CDevice() {
#if PLATFORM_LINUX
        if (fd_ >= 0) {
            close(fd_);
        }
...
void LSM9DS0Driver::I2CDevice::write(uint8_t dev_addr, uint8_t reg_addr, uint8_t value) {
#if PLATFORM_LINUX
...
uint8_t LSM9DS0Driver::I2CDevice::read_reg(uint8_t dev_addr, uint8_t reg_addr) {
#if PLATFORM_LINUX
        if (ioctl(fd_, I2C_SLAVE, dev_addr) < 0) {
            throw std::system_error(errno, std::system_category(), "Failed to set I2C slave address");
        }
